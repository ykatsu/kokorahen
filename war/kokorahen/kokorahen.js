...
// 現在位置イメージ。
var curPosImage = new google.maps.MarkerImage(
	"http://www.google.com/mapfiles/gadget/arrowSmall80.png", // url
	new google.maps.Size(31,27), // size
	new google.maps.Point(0,0),  // origin
	new google.maps.Point(8,27) // anchor
);
// 現在位置の影イメージ
var curPosShadowImage = new google.maps.MarkerImage(
    "http://www.google.com/mapfiles/gadget/arrowshadowSmall80.png", // url
    new google.maps.Size(31,27), // size
    new google.maps.Point(0,0),  // origin
    new google.maps.Point(8,27) // anchor
);
...
$("<div id='menuButton'>検索条件</div>")[0]);
	...
	marker = new google.maps.Marker({position: center, map: map,
		icon:curPosImage, shadow:curPosShadowImage
	});
